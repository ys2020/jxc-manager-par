...
// 打开添加商品类别菜单对话框
    function addGoodsTypeManagerTab(pId){
        var pId=$("input[name='typeId']").val();
        var url  =  ctx+"/goodsType/addGoodsTypePage?pId="+pId;
        var title="类别添加";
        layui.layer.open({
            title : title,
            type : 2,
    ...
    // 打开添加商品单位菜单对话框
    function addgoodsUnitManagerTab(pId){
        var pId=$("input[name='typeId']").val();
        var url  =  ctx+"/goodsUnit/addgoodsUnitPage";
        var title="类别添加";
        layui.layer.open({
            title : title,
            type : 2,
